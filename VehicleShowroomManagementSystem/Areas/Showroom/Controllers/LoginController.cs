...
namespace VehicleShowroomManagementSystem.Areas.Showroom.Controllers
{
    public class LoginController : Controller
    {
        ...
        public ActionResult Login(LoginModel model)
        {
            if (ModelState.IsValid)
            {
                ...
                if (result == 1)
                {
                    ...
                    userSession.Name = employee.Name;

                    Session.Add(Constants.SHOWROOM_SESSION, userSession);
        ...
        {
            Session[Constants.SHOWROOM_SESSION] = null;
            return Redirect("/Showroom/Login/Index");
        }
